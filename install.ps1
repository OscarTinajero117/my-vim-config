...
Write-Host "  2. Ejecuta :CocInfo para verificar que todo funciona"
Write-Host "  3. (Opcional) Si usas bases de datos, edita plugin-config.vim"
Write-Host "     y descomenta la secci\u00f3n 'g:dbs' con tus datos de conexi\u00f3n."
Write-Host "     Ejemplo: 'postgresql://usuario:password@localhost:5432/mi_db'"
Write-Host ""
